...
public class MaterialTimePicker extends MaterialWidget implements HasError, HasPlaceholder, HasOrientation,
    ...
    private final ErrorMixin<MaterialTimePicker, MaterialLabel> errorMixin = new ErrorMixin<>(this, this.lblError,
            this.input);
    ...
    public void initTimePicker() {
        this.initTimePicker(DOM.createUniqueId(), this.input.getElement(), this.getOrientation().getCssName(),
                this.isAutoClose(), this.isHour24());
    }
    ...
    protected void afterHide() {
        ...
        if (timeString != null && timeString.equals("") == false) {
            try {
                if (this.hour24 == true) {
